...
//    }
    ...
    private void submitRequest() {
        /**
         * Validates the faculty request form, checks blacklist status for the planned visit time,
         * validates gate timing, and then submits the visitor request.
         */
        ...
        checkActiveBlacklist(visitorCnic, visitDate, visitTime, () -> {
            VisitorRequestTimerValidator.validate(visitDate, visitTime, (isValid, errorMessage) -> {
                ...
                createVisitorRequest(visitorName, invitorName, visitorPhoneNumber, visitorCnic,
