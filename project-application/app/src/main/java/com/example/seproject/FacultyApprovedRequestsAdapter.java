...
/**
 * Faculty-facing approved/pre-approved requests (prefers {@link Request#getPassId()} for id line).
 *
 * @author Moiz Imran
 * @version 1.0
 */
public class FacultyApprovedRequestsAdapter extends RecyclerView.Adapter<FacultyApprovedRequestsAdapter.ViewHolder> {
     ...
     */
    public FacultyApprovedRequestsAdapter(@NonNull List<Request> initialItems) {
        items.clear();
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_approved_request_card_faculty, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String passOrRequestId = (request.getPassId() != null && !request.getPassId().isEmpty())
                ? request.getPassId()
                : request.getRequestId();
        holder.tvRequestId.setText(RequestDisplayFormatter.dashIfEmpty(passOrRequestId));
